...
![Interface de cmd.exe dans Windows Terminal](../assets/figures/cmd.png)

![Interface de PowerShell dans Windows Terminal](../assets/figures/powershell.png)

![Interface de Ubuntu dans Windows Terminal](../assets/figures/bash.png)
