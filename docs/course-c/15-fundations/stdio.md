...
```c include="docs/assets/src/iota.c"
```
...
::: exercise {title="#(ex:course-c-15-fundations-stdio-1)"}
...
::: exercise {title="#(ex:scanf-sur-des-entiers-et-des-reels) : scanf sur des entiers et des réels"}
...
::: exercise {title="#(ex:saisie-de-valeurs) : Saisie de valeurs"}
...
::: exercise {title="#(ex:chaines-de-formats) : Chaînes de formats"}
...
::: exercise {title="#(ex:test-de-saisir-correcte) : Test de saisir correcte"}
...
::: exercise {title="#(ex:produit-scalaire) : Produit scalaire"}
...
::: exercise {title="#(ex:crampes-de-doigts) : Crampes de doigts"}
...
::: exercise {title="#(ex:geometrie-affine) : Géométrie affine"}
...
::: exercise {title="#(ex:equation-de-droite) : Équation de droite"}
...
??? solution
    ...
    ```c include="docs/assets/src/linear.c"
    ```
:::

::: exercise {title="#(ex:loi-d-ohm) : Loi d'Ohm"}
...
::: exercise {title="#(ex:tour-eiffel) : Tour Eiffel"}
...
::: exercise {title="#(ex:hyperloop) : Hyperloop"}
...
::: exercise {title="#(ex:constantes-litterales-caracterielles) : Constantes littérales caractérielles"}
...
::: exercise {title="#(ex:chaines-de-formatage) : Chaînes de formatage"}
