...
::: exercise {title="#(ex:shadowy-escape) : Shadowy escape"}
...
::: exercise {title="#(ex:curieux-entier) : Curieux entier"}
Que vaut `x`
...
::: exercise {title="#(ex:vilains-crochets) : Vilains crochets"}
Que vaut `x`
...
::: exercise {title="#(ex:la-regle-gourmande) : La règle gourmande"}
Que vaut `x`
...
::: exercise {title="#(ex:collision-globale) : Collision globale"}
