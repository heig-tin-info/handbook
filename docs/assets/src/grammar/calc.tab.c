...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUMBER", "FUNCTION",
  "'+'", "'-'", "'*'", "'/'", "'('", "')'", "$accept", "expression",
...
{
       1,     2,     9,     7,    10,    11,     3,    10,    11,    15,
      10,    11,     8,    12,    13,    20,    14,    16,    17,     0,
      18,    19
};

static const yytype_int8 yycheck[] =
{
       3,     4,     0,     9,     5,     6,     9,     5,     6,    10,
       5,     6,     3,     7,     8,    10,     7,    10,    11,    -1,
      12,    13
};
...
{
       0,     3,     4,     9,    12,    13,    14,     9,    12,     0,
       5,     6,     7,     8,    12,    10,    13,    13,    14,    14,
      10
};
...
#line 24 "calc.y"
                          { (yyval.node) = create_operator_node('+', (yyvsp[-2].node), (yyvsp[0].node)); }
...
#line 1121 "calc.tab.c"
  ...
  case 10: /* factor: FUNCTION '(' expression ')'  */
#line 37 "calc.y"
                                  { (yyval.node) = create_function_node((yyvsp[-3].function), (yyvsp[-1].node)); }
